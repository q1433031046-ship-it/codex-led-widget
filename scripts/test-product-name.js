...
assert.equal(packageJson.version, "1.2.3", "Use a patch version for the multi-display continuity fixes");
...
assert.equal(packageJson.build.nsis.artifactName, "Codex-Quota-Desktop-Assistant-1.2.3-Windows-x64-Setup.exe");
assert.equal(packageJson.build.nsis.uninstallDisplayName, "Codex 额度桌面助手 1.2.3");
