...
assert.equal(packageJson.version, "1.2.4", "Use a patch version for the hover rendering and multi-display fixes");
...
assert.equal(packageJson.build.nsis.artifactName, "Codex-Quota-Desktop-Assistant-1.2.4-Windows-x64-Setup.exe");
assert.equal(packageJson.build.nsis.uninstallDisplayName, "Codex 额度桌面助手 1.2.4");
