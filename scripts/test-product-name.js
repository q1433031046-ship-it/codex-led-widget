...
assert.equal(packageJson.version, "1.2.2", "Use a patch version for the typography normalization");
...
assert.equal(packageJson.build.nsis.artifactName, "Codex-Quota-Desktop-Assistant-1.2.2-Windows-x64-Setup.exe");
assert.equal(packageJson.build.nsis.uninstallDisplayName, "Codex 额度桌面助手 1.2.2");
