...
assert.equal(packageJson.version, "1.1.2", "Use a valid semantic version for the initialization, docking, and settings hotfix");
...
assert.equal(packageJson.build.nsis.artifactName, "Codex-Quota-Desktop-Assistant-1.1.2-Windows-x64-Setup.exe");
assert.equal(packageJson.build.nsis.uninstallDisplayName, "Codex 额度桌面助手 1.1.2");
