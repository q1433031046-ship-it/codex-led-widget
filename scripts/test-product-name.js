...
assert.equal(packageJson.version, "1.1.1", "Use a valid semantic version for the initialization hotfix");
...
assert.equal(packageJson.build.nsis.artifactName, "Codex-Quota-Desktop-Assistant-1.1.1-Windows-x64-Setup.exe");
assert.equal(packageJson.build.nsis.uninstallDisplayName, "Codex 额度桌面助手 1.1.1");
