...
assert.equal(packageJson.version, "1.2.0", "Use a feature version for account-scoped records");
...
assert.equal(packageJson.build.nsis.artifactName, "Codex-Quota-Desktop-Assistant-1.2.0-Windows-x64-Setup.exe");
assert.equal(packageJson.build.nsis.uninstallDisplayName, "Codex 额度桌面助手 1.2.0");
