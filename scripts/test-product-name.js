...
assert.equal(packageJson.version, "1.1.0", "Use a valid semantic version internally for the displayed 1.1 release");
...
assert.equal(packageJson.build.nsis.artifactName, "Codex-Quota-Desktop-Assistant-1.1.0-Windows-x64-Setup.exe");
assert.equal(packageJson.build.nsis.uninstallDisplayName, "Codex 额度桌面助手 1.1");
